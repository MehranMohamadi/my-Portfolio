...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  const markdownComponents: Components = {
    ...
    table: ({ children, ...props }) => (
      <div className="my-6 -mx-6 w-auto overflow-x-auto border-y border-gray-200/80 dark:border-gray-700/80 sm:mx-0 sm:w-full sm:rounded-2xl sm:border">
        <table className="w-full table-fixed border-collapse text-xs sm:text-sm" {...props}>
          {children}
        </table>
      </div>
    ),
    th: ({ children, ...props }) => (
      <th
        className="break-words bg-gray-100/90 px-2 py-2 text-start font-semibold text-gray-900 dark:bg-gray-800/90 dark:text-gray-100 sm:px-4 sm:py-3"
        {...props}
      >
        {children}
      </th>
    ...
    td: ({ children, ...props }) => (
      <td className="break-words border-t border-gray-200/70 px-2 py-2 text-gray-700 dark:border-gray-700/70 dark:text-gray-300 sm:px-4 sm:py-3" {...props}>
        {children}
      </td>
    ),
