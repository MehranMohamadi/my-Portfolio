...
export const Header: React.FC = () => {
  const { language, setLanguage, theme, setTheme, setThemeWithRipple, isRTL } = useApp();
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            {['home', 'skills', 'projects', 'about', 'contact'].map((section, index) => (
              <motion.button
                ...
                className="relative px-3 py-2 text-gray-700 dark:text-gray-200 hover:text-transparent hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:bg-clip-text transition-all duration-300 font-medium"
                whileHover={{ y: -2 }}
                  ...
                  >
                    {languages.map((lang) => (
                      <motion.button
                        ...
                        whileHover={{ x: 5 }}
                        className={`block w-full text-left px-4 py-3 hover:bg-gradient-to-r hover:from-blue-500/20 hover:to-purple-500/20 transition-all duration-300 ${
                          language === lang.code ? 'bg-gradient-to-r from-blue-500/30 to-purple-500/30 text-blue-600 dark:text-blue-400 font-semibold' : 'text-gray-700 dark:text-gray-200'
                        }`}
                      >
                        {lang.name}
                      </motion.button>
            ...
            >
              {['home', 'skills', 'projects', 'about', 'contact'].map((section, index) => (
                <motion.button
                  key={section}
                  onClick={() => scrollToSection(section)}
                  className="block w-full text-left px-4 py-2 rounded-lg hover:bg-gradient-to-r hover:from-blue-500/20 hover:to-purple-500/20 transition-all duration-300"
                ...
                {languages.map((lang) => (
                  <motion.button
                    ...
                    className={`block w-full text-left px-4 py-2 rounded-lg transition-all duration-300 ${
                      language === lang.code
                        ? 'bg-gradient-to-r from-blue-500/30 to-purple-500/30 text-blue-600 dark:text-blue-400 font-semibold'
